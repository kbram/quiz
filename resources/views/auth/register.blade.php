            ...
            <div class=" loginContainer">
                <div class="login-box">
                    <div class="login-snip"> 
                        <input id="tab-1" type="radio" name="tab" class="sign-in" onclick="window.location='login'" >
                            ...
                            <div class="login mt-5">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="group"> <label for="pass"
                                        ...
                                        <input id="password" type="password" data-type="password"
                            ...
                            <div class="sign-up-form mt-5">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="group">
                                        ...
                                        <input id="password-confirm" data-type="password"
                                            placeholder="Repeat your password" type="password" class="input"
